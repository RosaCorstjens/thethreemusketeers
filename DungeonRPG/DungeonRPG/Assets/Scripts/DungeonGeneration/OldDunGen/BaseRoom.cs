...
public class BaseRoom
{
    ...
    public DungeonDirection enteringCorridor;    // The direction of the corridor that is entering this room.
    ...
    public void SetupRoom(IntRange widthRange, IntRange heightRange, int columns, int rows)
    {
        ...
        roomWidth = (int)widthRange.GetRandomInRange();
        roomHeight = (int)heightRange.GetRandomInRange();
    ...
    public void SetupRoom(IntRange widthRange, IntRange heightRange, int columns, int rows, BaseCorridor corridor)
    {
